table 123456710 "CSD Seminar Reg. Header"
{
        ...
        field(1;"No.";Code[20])
        {
            ...
            begin
                if "No." <> xRec."No." then begin
                  SeminarSetup.Get;
                  NoSeriesMgt.TestManual(SeminarSetup."Seminar Registartion Nos.");
                  "No. Series" := '';
                end;
            end;
        }
        ...
        field(3;"Seminar No.";Code[20])
        {
            ...
            begin
                if "Seminar No." <> xRec."Seminar No." then begin
                  ...
                  Duration := Seminar."Semniar Duration";
        ...
        field(27;"Posting No. Series";Code[10])
        {
            ...
            begin
                with SeminarRegHeader do begin
                  ...
                  SeminarSetup.GET;
                  SeminarSetup.TestField("Seminar Registartion Nos.");
    ...
    begin
        if "No." = '' then begin
          SeminarSetup.GET;
          SeminarSetup.TestField("Seminar Registartion Nos.");
          NoSeriesMgt.InitSeries(SeminarSetup."Seminar Registartion Nos.",xRec."No. Series",0D,"No.","No. Series");
        end;
    ...
    begin
        with SeminarRegHeader do begin
          ...
          SeminarSetup.GET;
          SeminarSetup.TestField("Seminar Registartion Nos.");
          if NoSeriesMgt.SelectSeries(SeminarSetup."Seminar Registartion Nos.",OldSeminarRegHeader."No. Series","No. Series") then begin
            SeminarSetup.GET;
            SeminarSetup.TestField("Seminar Registartion Nos.");
